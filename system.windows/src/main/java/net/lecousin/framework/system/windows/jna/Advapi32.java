...
public interface Advapi32 extends com.sun.jna.platform.win32.Advapi32 {
    ...
    boolean AllocateAndInitializeSid(SID_IDENTIFIER_AUTHORITY authority, byte subAuthorityCount, int subAuthority0, int subAuthority1, int subAuthority2, int subAuthority3, int subAuthority4, int subAuthority5, int subAuthority6, int subAuthority7, PSIDByReference psid);
